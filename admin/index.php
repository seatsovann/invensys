<?php
  ...
  if (isset($_SESSION["LOGIN_USR_ADMIN"])){
  ...
  if ($_SERVER["REQUEST_METHOD"] == "POST"){
      ...
      if (!isset($_POST["btn-signin"])){
          ...
          $sql = "select * from tbl_admin where usr_name = '$usrname' and usr_pwd = '$pwd' ";
          ...
          if ($datacount == 1){
              ...
              $_SESSION["LOGIN_USR_ADMIN"] = $data['usr_name'];
...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="source\style\admin-login.css">
  <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.2.1/jquery.min.js"></script> 
  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js"></script>
  <script src="source\js\admin-login.js"></script>
